        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    stockServices.receiveProduct(productDetails[0], productDetails[1],
                ...
                case 2:
                    ...
                    Product productNameInfo = stockServices.findProductByName(name);
                ...
                case 3:
                    ...
                    Product productBarcodeInfo = stockServices.findProductByBarcode(barcode);
                ...
                case 4:
                    ...
                    stockServices.returnProduct(returnDetails[0], Integer.parseInt(returnDetails[1]));
                    break;
                case 5:
                    System.out.print("Enter product barcode: ");
                    barcode = scanner.nextLine();
                    int productBarcodeQnt = stockServices.getTotalProductsByBarcode(barcode);
                    System.out.println("Quantity stored: " + productBarcodeQnt);
                    break;
                case 6:
                    System.out.print("Enter product name: ");
                    name = scanner.nextLine();
                    int productNameQnt = stockServices.getTotalProductsByName(name);
                ...
                case 7:
                    ...
                    stockServices.sellProduct(saleDetails[0], Integer.parseInt(saleDetails[1]));
                    break;
                case 8:
                    System.out.print("Enter batch ID: ");
                    int batchId = scanner.nextInt();
                    int batchTotal = stockServices.getBatchTotal(batchId);
                ...
                case 9:
                    ...
                    boolean alert = stockServices.hasLowStockAlert(lowStockDetails[0], Integer.parseInt(lowStockDetails[1]));
                    if (alert) {
